...
$dir    = 'bk/'; //'/storage/EFC7-1AFC/bk/'
$files2 = scandir($dir, 1);
foreach($files2 as $w) {
if (($w <> '..') and ($w <> '.')) 
$file2 = "$file2<br /><option>$w</option>"; }
...
<div style="position: absolute; left: 750px; top: 50px"><h3><select name="bk"><?php echo $file2?></select> <input type="submit" name="BackUp" value="BackUp" /></h3></div>
</form><br />
 ...
 * @author Daniel López Azana <daniloaz@gmail.com>
 * @version 1.0
 */
...
define("DB_NAME", 'cigla');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", '/storage/emulated/0/htdocs/bk/'); //'/storage/EFC7-1AFC/bk/' Comment this line to use same script's directory ('.')
define("BACKUP_FILE", $bk); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
?><meta http-equiv="refresh" content="10;url=\cigla/index.php"><?php } ?>
</body>
</html>