...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile              = date("Y-m-d").'.sql';
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            foreach($tables as $table) {
                $this->obfPrint("Backing up `".$table."` table...".str_repeat('.', 10-strlen($table)), 0, 0);
...
$i=0;
$dir    = '/storage/emulated/0/htdocs/bk/';
$files2 = scandir($dir, 1);
foreach($files2 as $w) { 	$i++;
if (($i > 5) and ($w <> '..') and ($w <> '.')) 
unlink("/storage/emulated/0/htdocs/bk/$w"); }




?><meta http-equiv="refresh" content="5;url=\cigla/index.php">